        ...
        child: ListView(
          children: [
            ...
            FAQItem(
              ...
              answer: "You can book a house by selecting its image or typing its name. Payment must be made via M-Pesa or Flutterwave before the house is confirmed as booked.",
            ),
            FAQItem(
              question: "What happens if I don't complete my payment?",
              answer: "Your booking will not be confirmed until payment is received. The house will still be available for others to book.",
            ),
            FAQItem(
              question: "Can I cancel a booking?",
              answer: "Yes, you can cancel your booking before the move-in date. This will reset the house's availability.",
            ),
            FAQItem(
              question: "How do I make a payment?",
              answer: "Payments are made via M-Pesa STK Push or Flutterwave. You'll receive a payment request on your phone to complete the transaction.",
            ),
            FAQItem(
...
class _ContactSupportState extends State<ContactSupport> {
  ...
  final List<Map<String, String>> supportContacts = [
    {"name": "Nick Dieda", "phone": "+254700742362", "email": "nickeagle888@gmail.com"},
  ...
  void _sendEmail(String email) async {
    final Uri emailUri = Uri(
      scheme: 'mailto',
      path: email,
      query: 'subject=House Booking Assistant Support&body=Describe your issue here...',
    );
